...
# --- SÉCURITÉ : SUPPRESSION FICHIER CORROMPU ---
...
if st.sidebar.button("➕ Créer Dossier"): 
    nom = st.sidebar.text_input("Nom"); st.session_state.config['dossiers'][nom] = []; st.rerun()
if st.sidebar.button("➕ Ajouter Matière"): 
    mat = st.sidebar.text_input("Nom Matière"); st.session_state.config['dossiers'][choix_dos].append(mat); st.rerun()
