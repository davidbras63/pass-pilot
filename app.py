...
def save_data_to_sheet(df):
    try:
        ...
        data_list = [df_to_send.columns.tolist()] + df_to_send.values.tolist()
        requests.post(WEB_APP_URL, json=data_list)
    except:
...
if 'data' not in st.session_state: st.session_state.data = load_data_from_sheet()
